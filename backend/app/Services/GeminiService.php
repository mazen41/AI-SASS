...
class GeminiService implements StoryTextGeneratorInterface
{
    ...
    private function buildStoryPrompt(
        ...
        // Constrain sceneCount to 8-12 pages for storybook format
...
2. In the "scenes" array, each element represents a STORYBOOK PAGE (not a movie scene).
3. Do NOT include camera movements or movie directions in the page descriptions.
4. Each page's "description" MUST be a long, rich paragraph of 120-180+ words.
5. The language of the "title", "story_text", page "title", and page "description" must strictly match the chosen story language (Arabic if language is Arabic).
